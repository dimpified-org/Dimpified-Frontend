...
const LightBlushTemplate = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      experience: "8+ years",
      image:
        "https://images.unsplash.com/photo-1534751516642-a1af1ef26a56?w=300",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl lg:text-7xl font-bold text-blue-900 mb-6 leading-tight">
                Create
                <span className="text-blue-400 block">Without Limits</span>
              </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-blue-600 max-w-2xl mx-auto">
              We offer a full range of creative services to bring your vision to
              life
            </p>
          </div>
            ...
            <div className="grid lg:grid-cols-2">
              ...
              <div className="bg-blue-400 p-12 text-white">
                ...
                <p className="text-blue-50 text-lg mb-8">
                  Have a project in mind? We'd love to hear about it. Let's make
                  something amazing.
                </p>
